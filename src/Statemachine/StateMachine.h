...
class StateMachine {
public:
    StateMachine(std::string game_name = "Default Name", int framerate = 60, int updaterate = 40, int eventrate=40,bool fullscreen = false); //here we set all the essentials
